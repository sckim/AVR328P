...
int main(void)
{
	...
	TCCR1C = 0x00;
	//OCR1A = 2500;	// 20ms 2500
	OCR1A = 6250;	// 50ms  6250
		...
		else
		{
			...
			{			
				...
				switch(display_mode) {
					...
					printf("SA%04d%04d%04d%06ld%06ld%06ldP\n", 4000+(int)(adxlx_angle*10.0), 4000+(int)(adxly_angle*10.0), 4000+(int)(adxlz_angle*10.0), 50000L+gyrox, 50000L+gyroy, 50000L+gyroz);
 				   break;
					case	cRaw: 
					ADXl345_ReadXYZ(&adxlx, &adxly, &adxlz);
