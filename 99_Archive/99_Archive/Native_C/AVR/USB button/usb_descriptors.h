...
//!
//! @version 1.2 at90usb162-2enum-mouse_ms-1_0_1 $Id: usb_descriptors.h,v 1.2 2006/12/12 10:23:43 arobert Exp $
//!
//! @todo
//! @bug
...
#define INTERFACE_SUB_CLASS_MOUSE 0x00    // No Sub Class
#define INTERFACE_PROTOCOL_MOUSE  0x02    // Mouse
...
#define EP_INTERVAL_1       0x08 				 // Interrupt polling interval from host
             // USB Mass Storage Interface descriptor
#define INTERFACE_NB        1
#define ALTERNATE           0
#define NB_ENDPOINT         2
#define INTERFACE_CLASS     0x08   		// Mass Storage Class
#define INTERFACE_SUB_CLASS 0x06			// SCSI transparent Command Set
#define INTERFACE_PROTOCOL  0x50			// Bulk-Only Transport
