...
//!
//! @version 1.8 at90usb162-2enum-mouse_ms-1_0_1 $Id: usb_standard_request.c,v 1.8 2006/11/30 15:07:56 arobert Exp $
//!
//! @todo
//! @bug
...
U8 dummy;
   ...
   if (bmRequestType == ZERO_TYPE)
   {
     ...
     if ((wValue == FEATURE_DEVICE_REMOTE_WAKEUP) && (USB_REMOTE_WAKEUP == ENABLED))
     {
       device_status |= USB_STATUS_REMOTEWAKEUP;
       usb_remote_wup_feature = ENABLED;
       Usb_ack_receive_setup();
       Usb_send_control_in();
     }
     else
