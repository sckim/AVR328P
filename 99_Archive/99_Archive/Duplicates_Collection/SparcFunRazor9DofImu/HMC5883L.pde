...
{   
          ...
          /*
          norm = 1.0 / sqrt(square(sen_data.magnetom_x)+square(sen_data.magnetom_y)+square(sen_data.magnetom_z)); 
          
          //The magnetic field inclination in Malmö is 70 degrees.
          
          ydot = -norm*sen_data.magnetom_y*cos(ToRad(80.0)) - norm*sen_data.magnetom_y*norm*sen_data.magnetom_z*sin(ToRad(80.0));
          zdot = norm*sen_data.magnetom_y*sin(ToRad(80.0)) + norm*sen_data.magnetom_z*cos(ToRad(80.0));
          xdot = sen_data.magnetom_x*norm;
          
          sen_data.magnetom_x = xdot/norm;
          sen_data.magnetom_y = ydot/norm;
          sen_data.magnetom_z = zdot/norm;
          */
