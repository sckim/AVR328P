...
void my_printdata(void)
{
  ...
  Serial.print(read_adc(1)); //Reversing the sign. 
  Serial.print(read_adc(2)); //Reversing the sign. 
  Serial.print(read_adc(3)); //Reversing the sign. 
  Serial.print(read_adc(4)); //Reversing the sign. 
  Serial.println(read_adc(5)); //Reversing the sign. 
}
