...
#define ACCEL_Z_MAX ((float) 227)

// Magnetometer (standard calibration)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -137)
#define MAGN_X_MAX ((float) 550)
#define MAGN_Y_MIN ((float) -441)
#define MAGN_Y_MAX ((float) 251)
#define MAGN_Z_MIN ((float) -334)
#define MAGN_Z_MAX ((float) 316)
...
#define GYRO_AVERAGE_OFFSET_X ((float) -27)
#define GYRO_AVERAGE_OFFSET_Y ((float) 34)
#define GYRO_AVERAGE_OFFSET_Z ((float) 4)
*/
// 9DOF #5
// "accel x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define ACCEL_X_MIN ((float) -272)
#define ACCEL_X_MAX ((float) 244)
...
// Magnetometer (standard calibration)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
#define MAGN_X_MIN ((float) -6)
#define MAGN_X_MAX ((float) 721)
#define MAGN_Y_MIN ((float) -505)
#define MAGN_Y_MAX ((float) 322)
#define MAGN_Z_MIN ((float) -186)
#define MAGN_Z_MAX ((float) 522)
...
// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -23)
#define GYRO_AVERAGE_OFFSET_Y ((float) 22)
#define GYRO_AVERAGE_OFFSET_Z ((float) -22)
